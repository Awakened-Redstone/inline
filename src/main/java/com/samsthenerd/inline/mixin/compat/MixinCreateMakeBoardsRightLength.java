package com.samsthenerd.inline.mixin.compat;
...
@Pseudo
@RequireMods("create")
@Mixin(targets="com.simibubi.create.content.trains.display.FlapDisplaySection", remap = false)
public class MixinCreateMakeBoardsRightLength {
    ...
    private int getInlineBasedTextLength(int spinningLength, int origLength, Operation<Integer> minOp, @Local LocalRef<String> textRef){
        if(!InlineClientConfig.applyCreateMixins){
